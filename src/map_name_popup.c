...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ELDEROOT_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OLD_ELDEROOT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DISTORTED_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
};
