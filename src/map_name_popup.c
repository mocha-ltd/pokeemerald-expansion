...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ELDEROOT_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OLD_ELDEROOT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DISTORTED_PATH] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_EVERGREEN_FOREST] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_4] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_3] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_2] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHIVERVALE_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROYALSPUR_CITY] = MAPPOPUP_THEME_MARBLE,
