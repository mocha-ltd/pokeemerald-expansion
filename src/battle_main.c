...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("{PKMN} TRAINER"), 20 },
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} TRAINER"), 20 },
    [TRAINER_CLASS_HIKER] = { _("HIKER"), 20 },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 17, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 13 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLLECTOR"), 20, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("SWIMMER♂"), 7, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 20 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 20 },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 13, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 25, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 11 },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 20 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 20 },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 17 },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 6 },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 6 },
    [TRAINER_CLASS_LADY] = { _("LADY"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 25 },
    [TRAINER_CLASS_RICH_BOY] = { _("RICH BOY"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 20 },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 13 },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 13 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 9 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 9 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 20 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 11 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 25, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 30, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("AVATAR"), 25 },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 9 },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 20 },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 25 },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 9 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50 },
    [TRAINER_CLASS_FISHERMAN] = { _("FISHERMAN"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 20 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 17 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 8 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 11 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 20 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 7, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 8 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 13 },
    ...
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 9 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 17 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 25, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 9 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 13 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 20 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 8 },
    ...
    [TRAINER_CLASS_TEAM_UMBRA] = { _("TEAM UMBRA"), 10 },
};
