static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ELDEROOT_TOWN - 1] = {MAP_GROUP(ELDEROOT_TOWN), MAP_NUM(ELDEROOT_TOWN), 5, 10},
    [HEAL_LOCATION_ELDEROOT_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(ELDEROOT_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(ELDEROOT_TOWN_PLAYERS_HOUSE_2F), 3, 5},
    [HEAL_LOCATION_SHIVERVALE_TOWN - 1] = {MAP_GROUP(SHIVERVALE_TOWN), MAP_NUM(SHIVERVALE_TOWN), 19, 18},
    [HEAL_LOCATION_ROYALSPUR_CITY - 1] = {MAP_GROUP(ROYALSPUR_CITY), MAP_NUM(ROYALSPUR_CITY), 13, 22},
};
